;;; ny-cursor-light-theme.el --- Cursor Dark inspired light theme -*- lexical-binding: t; -*-
...
;; A standalone light custom theme derived from Cursor Dark:
;; https://github.com/CedricVerlinden/cursor-dark/blob/master/themes/cursor-dark.json

;;; Code:

(deftheme ny-cursor-light
  "Light Emacs theme inspired by Cursor Dark.")
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (modeline-bg   "#ECECEA")
       (modeline-fg   "#25282D")
       (modeline-inactive-bg "#F7F7F4")
       (modeline-inactive-fg "#8B929A"))
  (custom-theme-set-faces
   ...
   `(isearch ((,class (:background ,cyan :foreground "#FFFFFF" :weight bold))))
   ...
   `(line-number-current-line ((,class (:background ,bg :foreground ,fg :weight bold))))
   ...
   `(diff-refine-added ((,class (:background ,green :foreground "#FFFFFF"))))
   `(diff-refine-removed ((,class (:background ,red :foreground "#FFFFFF"))))
   ...
   ;; Org
   `(org-document-title ((,class (:foreground ,fg :weight bold :height 1.1))))
   ...
   `(vertico-current ((,class (:background ,selection :foreground ,fg :extend t))))
   `(corfu-current ((,class (:background ,selection :foreground ,fg :extend t))))
...
(provide-theme 'ny-cursor-light)

;;; ny-cursor-light-theme.el ends here
